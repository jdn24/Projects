 ...
 * @author Jaden Ade
 */
public class Catdel extends javax.swing.JFrame {
...
String category=jTextField1.getText();
        try 
            ...
            String query="DELETE FROM CATEGORY WHERE CATEGORY='"+category+"';";
            stmt.executeUpdate(query);
            JOptionPane.showMessageDialog(this,"CATEGORY Deleted from Records");
            Admin log = new Admin();
        log.setVisible(true);
